	...
	var $window = $( window ),
		...
		_createSingleViewNavigation = function() {
			...
			if( Gamma.itemsCount > 1 ) {
				...
				Gamma.nav = $( '<nav class="gamma-nav"><span class="gamma-prev"><i class="fa fa-chevron-left"></i></span><span class="gamma-next"><i class="fa fa-chevron-right"></i></span></nav>' ).appendTo( Gamma.singleview );
